    ...
    <Container>
      ...
      <div className="border flex flex-col items-center px-4 md:px-6 py-4 max-w-2xl mx-auto">
        ...
        <div className="text-center">
          {data.links.webcast &&
            <a href={data.links.webcast} target="_blank" className="inline-flex gap-1 p-2 hover:opacity-60">
          ...
          {data.links.wikipedia &&
            <a href={data.links.wikipedia} target="_blank" className="inline-flex gap-1 p-2 hover:opacity-60">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
